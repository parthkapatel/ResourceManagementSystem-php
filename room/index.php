<?php 
  ...
  {
   $res = $con->insertRoomData($_REQUEST['roname'],$_REQUEST['rodes']);
   if($res == 1)
   {
   ...
   {
       echo "<script>alert('Room is not added');</script>";
   }
     ...
     <div class="container-fluid">
       ...
       <div class="sidebar">
            ...
            <div class="container active">
                <a href="index.php"><h5><i class="fa fa-fw fa-upload"></i>add rooms</h5></a>
            </div>
           <div class="container">
        ...
        <div class="main">
            <div class="container-fluid" id="mainformdiv">
              <div class="container" id="formdiv">
                  <h1 style="text-align:center;">Add New Room</h1>
                        <form method="POST" action="">
                            
                              
                            <div class="row">
                                <div class="col-25">
                                    <label for="roname">Room Name :</label>
                                </div>
                                <div class="col-75">
                                     <input type="text" id="roname" name="roname" placeholder="Room name.." >
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                     <label for="rodes">Room Description :</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" id="rodes" name="rodes" placeholder="Room Description.." >
                                </div>
                            </div>
                            <div class="btn">
                                
                                <input type="submit" class="btn btn-success" name="btn_sub" value="Add room">

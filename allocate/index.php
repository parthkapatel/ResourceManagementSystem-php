     ...
     <div class="container-fluid">
       ...
       <div class="sidebar">
           ...
           <div class="container active">
               <a href="index.php"><h5><i class="fa fa-fw fa-upload"></i>allocate resource's</h5></a>
            </div>
            <div class="container">
        ...
        <div class="main">
            <div class="container-fluid" id="mainformdiv">
              <div class="container" id="formdiv">
                  <h1 style="text-align:center;">Allocate Resources</h1>
                        <form method="POST" action="">
                            
                              
                            <div class="row">
                                <div class="col-25">
                                    <label for="aroom">Select Room :</label>
                                </div>
                                <div class="col-75">
                                    <select id="room">
                                    <?php
                                        $res=$con->fetchRoomData();
                                        foreach ($res as $row): ?>
                                          <option value="<?php echo $row['roid'] ?>"><?php echo $row['roname']?></option>
                                      <?php endforeach ?>
                                      </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                     <label for="ares">Select resource :</label>
                                </div>
                                <div class="col-75">
                                <select id="room">
                                    <?php
                                        $res=$con->fetchResData();
                                        foreach ($res as $row1): ?>
                                          <option value="<?php echo $row1['rid'] ?>"><?php echo $row1['rname'].' - '.$row1['rqty']?></option>
                                      <?php endforeach ?>
                                      </select>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-25">
                                    <label for="aqty">Resources quantity :</label>
                                </div>
                                <div class="col-75">
                                    <input type="number" id="aqty" name="aqty" placeholder="Resources quantity.." >
                                </div>
                            </div>
                            <div class="btn">
                                
                                <input type="submit" class="btn btn-success" name="addall" value="Add Resource">
...
if(isset($_REQUEST['addall']))
  {
  $res = $con->insertallData($row['roid'],$row1['rid'],$_REQUEST['aqty']);
   if($res == 1)
   {
